...
template <> constexpr inline auto StatusWindow::qt_create_metaobjectdata<qt_meta_tag_ZN12StatusWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(User &)>(4, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 5, 6 },
        }}),
        // Slot 'clearStories'
        QtMocHelpers::SlotData<void(QWidget *)>(7, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 8, 9 },
        }}),
    };
...
void StatusWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_addStoryButton_clicked(); break;
        case 2: _t->initializeStoriesPage((*reinterpret_cast< std::add_pointer_t<User&>>(_a[1]))); break;
