...
""));
        ...
        storyContentBox->setGeometry(QRect(640, 0, 600, 720));
...
"color: rgba(255, 255, 255, 128);"));
        ...
        sizePolicy9.setHeightForWidth(storyScreen->sizePolicy().hasHeightForWidth());
        storyScreen->setSizePolicy(sizePolicy9);
...
"color: #FFF;"));
        storyScreen->setPixmap(QPixmap(QString::fromUtf8(":/assets/assets/images.jpg")));
...
"border: none;"));
        ...
        myStoriesButton_2 = new QPushButton(centralwidget);
        myStoriesButton_2->setObjectName("myStoriesButton_2");
        myStoriesButton_2->setGeometry(QRect(460, 460, 140, 70));
        sizePolicy6.setHeightForWidth(myStoriesButton_2->sizePolicy().hasHeightForWidth());
        myStoriesButton_2->setSizePolicy(sizePolicy6);
        myStoriesButton_2->setMinimumSize(QSize(0, 0));
        myStoriesButton_2->setFont(font1);
        myStoriesButton_2->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
        myStoriesButton_2->setLayoutDirection(Qt::LayoutDirection::LeftToRight);
        myStoriesButton_2->setAutoFillBackground(false);
        myStoriesButton_2->setStyleSheet(QString::fromUtf8("background-color: #E7F1E6;\n"
"border: none;\n"
"border-radius: 30px;\n"
"text-align: left;\n"
"color: #000;\n"
"qproperty-alignment: 'AlignHCenter | AlignVCenter';"));
    ...
    void retranslateUi(QMainWindow *StoriesWindow)
    {
        ...
        myStoriesButton_2->setText(QCoreApplication::translate("StoriesWindow", "My stories", nullptr));
    } // retranslateUi
