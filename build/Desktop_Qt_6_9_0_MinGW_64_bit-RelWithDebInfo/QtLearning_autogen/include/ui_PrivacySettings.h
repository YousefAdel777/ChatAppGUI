...
"}"));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icons/BackArrow.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ExcludeContactsBack->setIcon(icon2);
...
"}"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 348, 352));
