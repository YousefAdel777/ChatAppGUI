...
template <> constexpr inline auto Header::qt_create_metaobjectdata<qt_meta_tag_ZN6HeaderE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'searchDone'
        QtMocHelpers::SignalData<void(vector<int>)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
        // Signal 'searchStart'
...
void Header::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->searchCancel((*reinterpret_cast< std::add_pointer_t<string>>(_a[1]))); break;
        case 1: _t->searchDone((*reinterpret_cast< std::add_pointer_t<vector<int>>>(_a[1]))); break;
        case 2: _t->searchStart(); break;
        case 3: _t->on_Name_clicked(); break;
        case 4: _t->on_LastSeen_clicked(); break;
        case 5: _t->on_Dots_clicked(); break;
        case 6: _t->on_search_clicked(); break;
        case 7: _t->on_close_search_clicked(); break;
        case 8: _t->initializeSearchBar(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Header::*)(string )>(_a, &Header::searchCancel, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Header::*)(vector<int> )>(_a, &Header::searchDone, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Header::*)()>(_a, &Header::searchStart, 2))
            return;
    }
}
...
// SIGNAL 0
void Header::searchCancel(string _t1)
{
