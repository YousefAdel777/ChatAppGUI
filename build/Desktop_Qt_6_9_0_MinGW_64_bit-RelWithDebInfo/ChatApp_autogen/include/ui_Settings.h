...
"padding: 50px;"));
        ...
        profileImageLabel->setPixmap(QPixmap(QString::fromUtf8(":/icons/user.png")));
...
"background-color: \"#D3E8D2\";\n"
"border-radius: 20px;"));
        label_16->setPixmap(QPixmap(QString::fromUtf8(":/icons/padlock.png")));
...
"background-color: \"#D3E8D2\";"));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icons/arrow-right.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        profileScrollArea = new QScrollArea(widget_7);
        profileScrollArea->setObjectName("profileScrollArea");
        QSizePolicy sizePolicy(QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Expanding);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(profileScrollArea->sizePolicy().hasHeightForWidth());
        profileScrollArea->setSizePolicy(sizePolicy);
        profileScrollArea->setMinimumSize(QSize(900, 720));
        profileScrollArea->setMaximumSize(QSize(16777215, 16777215));
        profileScrollArea->setStyleSheet(QString::fromUtf8("padding: 0; \n"
"margin: 0;\n"
"border: none;"));
...
"font-size: 30px"));
        ...
        profileImageLabel_2->setGeometry(QRect(40, 0, 64, 81));
        profileImageLabel_2->setMaximumSize(QSize(90, 16777215));
        profileImageLabel_2->setStyleSheet(QString::fromUtf8("padding: 0;"));
        profileImageLabel_2->setPixmap(QPixmap(QString::fromUtf8(":/icons/user.png")));
        ...
        addImageBtn->setGeometry(QRect(80, 50, 30, 30));
...
"border-radius: 16px;"));
        ...
        profileScrollArea->setWidget(scrollAreaWidgetContents_2);

        verticalLayout_2->addWidget(profileScrollArea, 0, Qt::AlignmentFlag::AlignHCenter);

        privacySettings = new QWidget(widget_7);
        privacySettings->setObjectName("privacySettings");
        verticalLayout_3 = new QVBoxLayout(privacySettings);
