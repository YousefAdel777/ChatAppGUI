...
template <> constexpr inline auto Search::qt_create_metaobjectdata<qt_meta_tag_ZN6SearchE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'searchDone'
        QtMocHelpers::SignalData<void(vector<int>)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Slot 'performSearch'
...
void Search::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->searchDone((*reinterpret_cast< std::add_pointer_t<vector<int>>>(_a[1]))); break;
        case 1: _t->performSearch(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Search::*)(vector<int> )>(_a, &Search::searchDone, 0))
            return;
    }
}
...
// SIGNAL 0
void Search::searchDone(vector<int> _t1)
{
